...
public class MsgUtils {
	...
	public static List<byte[]> toLongMessage(String msg, String cusMsisdn, GateWayConfig config) {
		try {
			...
			for (int i = 0; i < msgSendCount; i++) {
				...
				submit.setMsgSrc(config.getSpId());
				submit.setSrcId(config.getSpCode());
	...
	public static byte[] toShortMessage(String msg, String cusMsisdn, GateWayConfig config) {
		try {
