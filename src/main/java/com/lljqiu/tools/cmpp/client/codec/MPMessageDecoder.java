...
import com.lljqiu.tools.cmpp.client.stack.*;
...
public class MPMessageDecoder extends CumulativeProtocolDecoder {
    ...
    protected boolean doDecode(IoSession session, IoBuffer in, ProtocolDecoderOutput out) throws Exception {
        ...
        logger.info("commadnId={}",commadnId);
        ...
        switch (commadnId) {
        	case MsgCommand.CMPP_ACTIVE_TEST:
                ...
                activeResp.setCommandId(message.getMsgCommand());
                message.setBodys((JSONObject)JSONObject.toJSON(activeResp));
        		break;
